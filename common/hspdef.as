...
//#define _HSP3DISH_AS	//  When include hsp3dish.as, remove this comment out
#ifdef _HSP3DISH_AS
	#define NOTUSE_USER_DEF_WIN32
	//#define NOTUSE_USER_DEF_CALC
	#define NOTUSE_USER_DEF_DRAW
	#define NOTUSE_USER_DEF_ALPHA
	
	#include "when_included_hsp3dish.as"
#else
	//#define NOTUSE_USER_DEF_WIN32
	//#define NOTUSE_USER_DEF_CALC
	//#define NOTUSE_USER_DEF_DRAW
